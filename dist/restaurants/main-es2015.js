...
const routes = [
    ...
    { path: 'place/:id', component: _restaurant_restaurant_component__WEBPACK_IMPORTED_MODULE_4__["RestaurantComponent"] }
];
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _google_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../google.service */ "./src/app/google.service.ts");




let RestaurantComponent = class RestaurantComponent {
    constructor(route, googleApi) {
        this.route = route;
    ...
    ngOnInit() {
        ...
        this.googleApi.getPlaceDetails(this.placeId).subscribe((res) => {
            console.log(res);
            this.restaurant = {
...
let SearchComponent = class SearchComponent {
    ...
    onSubmit() {
        if (this.searchForm.value) {
            ...
            this.googleApi.getSearch(this.searchForm.value).subscribe((res) => {
...
module.exports = __webpack_require__(/*! /mnt/Shared/Documents/SoftwareEngineering/labs/restaurants/src/main.ts */"./src/main.ts");
